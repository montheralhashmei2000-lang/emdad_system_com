...
from ui import print_helper
from ui.print_helper import print_inventory_report
...
class InventoryView(QWidget):
    ...
    def _init_ui(self):
        ...
        self.lbl_total = self._make_stat("إجمالي الأصناف", "0", COLORS["primary"])
    ...
    def _make_stat(self, title, value, color):
        ...
        t.setStyleSheet(f"font-size: 11px; color: {COLORS['text_secondary']};")
        lay.addWidget(t)
