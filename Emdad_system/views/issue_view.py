from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QGridLayout, QFormLayout, QLineEdit, QComboBox, QPushButton, QHBoxLayout, QMessageBox, QDateEdit, QTableWidget, QTableWidgetItem, QHeaderView, QLabel, QSpinBox, QTabWidget, QRadioButton, QButtonGroup, QScrollArea, QFrame, QSizePolicy, QStackedWidget, QTabBar, QInputDialog)
...
# VoucherDetailsDialog placeholder (original was a separate file not yet recovered)
VoucherDetailsDialog = None
try:
    from voucher_dialog import VoucherDetailsDialog as _VDD
    VoucherDetailsDialog = _VDD
except Exception:
    pass
try:
    from views.voucher_dialog import VoucherDetailsDialog as _VDD2
    VoucherDetailsDialog = _VDD2
except Exception:
    pass
